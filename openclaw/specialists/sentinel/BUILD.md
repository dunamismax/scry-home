...
- [x] Confirm workspace tracking model (not a git repo; backed up/synced via grimoire)
...
- Confirmed `~/.openclaw/workspace-sentinel` is intentionally not a tracked git repo; backup/sync flows through grimoire.
