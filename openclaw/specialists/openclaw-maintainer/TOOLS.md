...
- **Git-based install**: `~/openclaw` (main branch, v2026.3.3+) — this is the LIVE runtime, do NOT make changes here
- **Fork for contributions**: `~/github/forks/openclaw` — this is where we clone, branch, and submit PRs from
