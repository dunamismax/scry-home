...
```bash
git -C <repo> config core.hooksPath /Users/sawyer/.openclaw/workspace-research/hooks/git
```
...
- Shared reusable OpenClaw prompts are mirrored locally under `/Users/sawyer/.openclaw/workspace-research/prompts/openclaw/`.
